...
const ChatThemeDropdown: React.FC = () => {
  ...
  //setup the event listeners to handle the click outside of the dropdown behavior
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className="absolute right-0 z-10 mt-1 w-32 border 
		 	rounded-lg 
		 
		  border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-lg text-xs"
          role="menu"
